...
const LINKING_ERROR =
  `The package 'react-native-document-scanner-plugin-legacy' doesn't seem to be linked. Make sure: \n\n` +
  Platform.select({ ios: "- You have run 'pod install'\n", default: '' }) +
  '- You rebuilt the app after installing the package\n' +
  '- You are not using Expo managed workflow\n';

const DocumentScannerLegacy = NativeModules.DocumentScannerLegacy
  ? NativeModules.DocumentScannerLegacy
  : new Proxy(
      {},
      {
        get() {
...
export default {
  ...
  scanDocument(
    ...
    return DocumentScannerLegacy.scanDocument(options);
  },
};
